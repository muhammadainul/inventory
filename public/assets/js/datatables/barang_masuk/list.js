jQuery(document).ready(function() {
    var myTable = $('#barangMasukTable').DataTable({
        bAutoWidth: false,
        search: true,
        serverSide: true,
        ajax       : {
            type : "POST",
            url  : "/transaksi/barang_masuk/datatables",
            data : data => {
                // Read values
        ...
        columns       : [
            ...
            { data: "tanggal_input", orderable: true },
        ...
        columnDefs: [
            ...
            },
            {
                ...
                createdCell : (td, cellData, rowData, row, col) => {
                    ...
                    <a href='/transaksi/barang_masuk/edit/${cellData}' 
                    class='btn btn-success btn-sm
                    data-toggle='tooltip' data-placement='top' title='Edit Barang Masuk'>
                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                    <a href='#' class='btn btn-danger btn-sm deleteBarangMasuk'
                    data-id=` + cellData + ` data-total='${rowData.jumlah}'
                    data-barang='${rowData.barang_id}' data-toggle='modal' data-target='
                    deleteBarangMasuk' data-toggle='tooltip' data-placement='top' title='Hapus Barang Masuk'>
    ...
    jQuery("#buttonFilterBarangMasuk").click(() => {
        myTable.draw()
    })
